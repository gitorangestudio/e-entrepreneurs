...
?>
   ...
   <div class="team-contents col-md-4 col-sm-6 col-xs-12" data-animation="flipInX" data-animation-delay="1000">
      <div class="picture">
      ...
      <div class="description">
       ...
       <a href="<?php print $node_url; ?>" class="project-link">View Project</a>
   </div>