 ...
 */
    ...
    if(isset($fields['flagged']->raw)){
      $flag = $fields['flagged']->raw;
    }else {
      $flag = 0;
    }
    $flag_content = '<i class="fa fa-check-circle-o"></i>';
   if($flag == 1) {
    $flag_content = '<i class="fa fa-check-circle"></i>';
   }
   
?>

<div class="check-icon"><?php print $flag_content; ?></div>
...
<?php if(isset($fields['nothing']->content)): ?>
