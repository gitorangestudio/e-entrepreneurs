 ...
 $(document).ready(function(){ 
     ...
     $( ".cp-link" )
      ...
      .on( "mouseleave", function() {
        ...
        $(this).stop().animate({left: -135},200);
      });
...
"use strict";
    ...
    $('.pane-node-create-links a').each(function(){
        var value = $(this).html();
        var new_value = 'Create New ' + value;
        $(this).html(new_value);
    });  
});
...
$('#block-menu-menu-member-menu .menu a').click(function(){
